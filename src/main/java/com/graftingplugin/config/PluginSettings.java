...
public record PluginSettings(Material focusMaterial, String focusName, int interactionRange) {
    ...
    public static PluginSettings fromConfig(FileConfiguration config) {
        ...
        return new PluginSettings(focusMaterial, focusName, interactionRange);
    }
}
